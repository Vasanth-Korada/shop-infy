...
class _DashboardState extends State<Dashboard> {
  ...
  Future<void> createJIRATicket({
    ...
    if (response.statusCode == 201) {
      ...
      await sendEmail(jiraUrl: "https://infytech.atlassian.net/jira/software/projects/KAN/boards/1?selectedIssue=${jsonDecode(response.body)["key"]}");
    } else {
  ...
  Future<void> sendEmail({required String jiraUrl}) async {
    final smtpServer = gmail('infytech2019@gmail.com', 'sqms snnk kykp ycuw');

    final message = Message()
      ..from = const Address('infytech2019@gmail.com', 'DevGuard AI')
      ..recipients.add('vasanthkorada999@gmail.com')
      ..subject = 'Priority: High - JIRA ISSUE ASSIGNED'
      ..text = 'Please click the below JIRA link to know more about the high priority bug $jiraUrl'
    ..html = '<a href="$jiraUrl">JIRA ISSUE LINK</a>';
